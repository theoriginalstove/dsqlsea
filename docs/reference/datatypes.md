...
[overrides list](config#overrides) in your `sqlc` config file.
...
(see [Overriding types](../howto/overrides) for details).
...
1. Configure sqlc to use `*github.com/twpayne/go-geos.Geom` for geometry types (see [Overriding types](../howto/overrides) for details).
...
package for working with PostGIS geometry types. See [Overriding types](../howto/overrides) for more information.
