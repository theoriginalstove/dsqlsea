...
Starting in sqlc 1.27.0, [managed databases](../howto/managed-databases) will require a database server URI in the configuration file.
...
You must be running sqlc v1.31.1 or greater to have access to the `servers`
configuration.
