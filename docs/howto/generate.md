...
The database-backed analyzer currently supports PostgreSQL, with [MySQL](https://github.com/theoriginalstove/dsqlsea/issues/2902) and [SQLite](https://github.com/theoriginalstove/dsqlsea/issues/2903)
