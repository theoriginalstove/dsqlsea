...
func (q *Queries) FilterRecords(ctx context.Context, db DBTX, tenantID int64, opts FilterRecordsOpts) ([]FilterRecordsRow, error) {
	query := filterRecords
	queryParams := []interface{}{tenantID}
...
func (q *Queries) GetRecord(ctx context.Context, db DBTX, tenantID int64, opts GetRecordOpts) (GetRecordRow, error) {
	query := getRecord
	queryParams := []interface{}{tenantID}
	conds := make([]string, 0, 2)
	n := 1
...
func (q *Queries) ListActiveRecords(ctx context.Context, db DBTX, arg ListActiveRecordsParams, opts ListActiveRecordsOpts) ([]ListActiveRecordsRow, error) {
...
func (q *Queries) ListRecords(ctx context.Context, db DBTX, tenantID int64, opts ListRecordsOpts) ([]ListRecordsRow, error) {
	query := listRecords
	queryParams := []interface{}{tenantID}
	conds := make([]string, 0, 2)
	n := 1
...
func (q *Queries) SearchRecords(ctx context.Context, db DBTX, tenantID int64, opts SearchRecordsOpts) ([]SearchRecordsRow, error) {
	query := searchRecords
	queryParams := []interface{}{tenantID}
	conds := make([]string, 0, 1)
	n := 1
