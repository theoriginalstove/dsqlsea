...
const listRecordsWithProfile = `-- name: ListRecordsWithProfile :many
...
type ListRecordsWithProfileRow struct {
	ID        int64
	Name      string
	Age       int32
	Status    string
...
type ListRecordsWithProfileOpts struct {
	bio     *sql.NullString
	orderBy []string
}

func (o ListRecordsWithProfileOpts) Bio(v sql.NullString) ListRecordsWithProfileOpts {
	o.bio = &v
	return o
}

type ListRecordsWithProfileOrderByColumn string

const (
	ListRecordsWithProfileOrderByName        ListRecordsWithProfileOrderByColumn = "name"
	ListRecordsWithProfileOrderByAge         ListRecordsWithProfileOrderByColumn = "age"
	ListRecordsWithProfileOrderByCreatedAt   ListRecordsWithProfileOrderByColumn = "created_at"
	ListRecordsWithProfileOrderByProfilesBio ListRecordsWithProfileOrderByColumn = "profiles.bio"
)

func (o ListRecordsWithProfileOpts) OrderBy(col ListRecordsWithProfileOrderByColumn, desc bool) ListRecordsWithProfileOpts {
	dir := " ASC"
	if desc {
		dir = " DESC"
	}
...
func (q *Queries) ListRecordsWithProfile(ctx context.Context, tenantID int64, opts ListRecordsWithProfileOpts) ([]ListRecordsWithProfileRow, error) {
	query := listRecordsWithProfile
	queryParams := []interface{}{tenantID}
	conds := make([]string, 0, 1)
	n := 1
	_ = n
	...
	defer rows.Close()
	var items []ListRecordsWithProfileRow
	for rows.Next() {
		var i ListRecordsWithProfileRow
		if err := rows.Scan(
			&i.ID,
			&i.Name,
			&i.Age,
...
const listRecordsWithProfileStaticWhere = `-- name: ListRecordsWithProfileStaticWhere :many
SELECT r.id, r.name, r.age, r.status, r.created_at, p.bio, p.avatar_url
FROM records r
LEFT JOIN profiles p ON r.id = p.record_id
WHERE r.tenant_id = $1
...
type ListRecordsWithProfileStaticWhereParams struct {
	TenantID int64
	Name     string
}

type ListRecordsWithProfileStaticWhereRow struct {
	ID        int64
	Name      string
	Age       int32
	Status    string
...
type ListRecordsWithProfileStaticWhereOpts struct {
	bio     *sql.NullString
	orderBy []string
}

func (o ListRecordsWithProfileStaticWhereOpts) Bio(v sql.NullString) ListRecordsWithProfileStaticWhereOpts {
	o.bio = &v
	return o
}

type ListRecordsWithProfileStaticWhereOrderByColumn string

const (
	ListRecordsWithProfileStaticWhereOrderByName        ListRecordsWithProfileStaticWhereOrderByColumn = "name"
	ListRecordsWithProfileStaticWhereOrderByAge         ListRecordsWithProfileStaticWhereOrderByColumn = "age"
	ListRecordsWithProfileStaticWhereOrderByCreatedAt   ListRecordsWithProfileStaticWhereOrderByColumn = "created_at"
	ListRecordsWithProfileStaticWhereOrderByProfilesBio ListRecordsWithProfileStaticWhereOrderByColumn = "profiles.bio"
)

func (o ListRecordsWithProfileStaticWhereOpts) OrderBy(col ListRecordsWithProfileStaticWhereOrderByColumn, desc bool) ListRecordsWithProfileStaticWhereOpts {
	dir := " ASC"
	if desc {
		dir = " DESC"
	}
...
func (q *Queries) ListRecordsWithProfileStaticWhere(ctx context.Context, arg ListRecordsWithProfileStaticWhereParams, opts ListRecordsWithProfileStaticWhereOpts) ([]ListRecordsWithProfileStaticWhereRow, error) {
	query := listRecordsWithProfileStaticWhere
	queryParams := []interface{}{arg.TenantID, arg.Name}
	conds := make([]string, 0, 1)
	n := 2
	_ = n
	if opts.bio != nil {
	...
	defer rows.Close()
	var items []ListRecordsWithProfileStaticWhereRow
	for rows.Next() {
		var i ListRecordsWithProfileStaticWhereRow
		if err := rows.Scan(
			&i.ID,
			&i.Name,
			&i.Age,
